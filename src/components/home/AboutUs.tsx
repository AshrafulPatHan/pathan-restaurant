...
const AboutUs = () => {
    return (
        <section className="bg-white py-low">
            <div className="max-w-[1500px] mx-auto bg-[#F6F6F6] backdrop-blur-[8.3px] p-8 rounded-md border-[1.5px] border-[#ddd] border-dashed ">
                <div className="bg-white p-6 rounded-xl border-[1.5px] border-[#ddd] border-dashed flex flex-col lg:flex-row justify-between ">
                    ...
                    <div className="relative">
                        ...
                        <div className="absolute z-20 -bottom-10 -left-20 border border-dotted border-[#ddd] p-4 bg-[#ffffff15] backdrop-blur-[1.3px] rounded-2xl ">
                            <img src={picake} alt="image" className="w-[166px] h-[110px] rounded-lg " />
                        </div>
                        <div className="absolute z-20 -top-10 -right-20 border border-dotted border-[#ddd] p-4 bg-[#ffffff15] backdrop-blur-[1.3px] rounded-2xl ">
